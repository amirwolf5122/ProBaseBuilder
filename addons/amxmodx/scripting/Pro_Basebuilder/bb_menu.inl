...
public helpingMenu(id)
{
	...
	if (ArePlayersTeammates(id, target))
	{
...
public helpingMenu_2(id, menu, item)
{
	...
	if (ArePlayersTeammates(id, target) || ArePlayersOnSameTeam(id, target))
	{
...
public SetRandomPlayerColor(id)
{
	...
	if (ArePlayersTeammates(id, teammate) && hasOption(userSaveOption[id], save_TEAM_COLOR) && hasOption(userSaveOption[teammate], save_TEAM_COLOR))
	{
		if (g_iColorMode)
		{
