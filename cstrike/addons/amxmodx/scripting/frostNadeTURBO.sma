...
new const sprite_grenade_frost[] = "sprites/blueflare2.spr";
...
public plugin_precache()
{
	...
	frost = precache_model(sprite_grenade_frost)
...
CreateBlast(const origin[3])
{
	...
	write_coord(origin[2]); // something Z
	write_short(frost) // sprite index
